...
export default function LinksComp(){
    return (
        <div className="bg-gradient-to-r from-[#18181b] via-custom-dark to-neutral-900 w-[100%] md:mx-20 mx-16 mt-10 opacity-80 bg-inc-800/40 border-[1px] border-neutral-800 shadow-xl  rounded-xl">
