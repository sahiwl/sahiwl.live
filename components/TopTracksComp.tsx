...
export function TopTracksComp() {
  ...
  return (
    <section className="flex flex-col gap-4 md:mt-0 mt-8  justify-between items-center w-3/4 md:pt-8 prose font-exo2 mb-12">
      {data.length > 0 && (
        <div className="flex flex-col gap-2  md:w-1/2 p-4 rounded-lg shadow-lg border bg-gradient-to-r  dark:from-[#18181b] dark:via-custom-dark dark:to-neutral-900 border-zinc-700">
